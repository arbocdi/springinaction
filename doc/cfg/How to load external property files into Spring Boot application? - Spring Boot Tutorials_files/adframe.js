...
initVdo({
  ...
  adTagUrl: window.location.protocol + "//vdo.ai/core/java2novice/ads_vmap.php",
  path: window.location.protocol + "//vdo.ai/core/java2novice/adframe.js?k=4er"
});
